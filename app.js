...
const NOTICES = {
  1: { id:1, short:'N1', icon:'ti-coin', title:'Dealings in Currency, Gold and Other Precious Metals',
    ...
    secs: [
      ...
      {ref:'Part A, fn. 1 (Para 1(1))',title:'Forward Basis — early receipt of Export of Goods proceeds (illustration)',body:'Illustration: On 1 June 2020, a Resident enters into a Forward Basis transaction for underlying receipt of proceeds of Export of Goods (i.e. sell Foreign Currency against Ringgit) for delivery on 30 June 2020. However, the proceeds of Export of Goods were received earlier than anticipated, i.e. prior to the maturity of the Forward Basis transaction and credited into Trade FCA. The Resident has the options to either (1) take an early delivery of the Forward Basis transaction; or (2) wait until the maturity of the Forward Basis transaction by debiting Foreign Currency from the Resident\'s Trade FCA maintained with a LOB.'},
      {ref:'Part A, Para 1(2)',title:'Resident — unwind of Forward Basis (Portfolio Investment exception)',body:'A Resident is allowed to unwind a Forward Basis transaction undertaken in accordance with paragraph 1(1)(b) with any LOB, EXCEPT for a transaction where the Firm Commitment is a Portfolio Investment.'},
      ...
      {ref:'Part A, fn. 2 (Para 3)',title:'Dynamic Hedging registration — Resident Entity transacting for the Principal',body:'A transaction that is undertaken pursuant to the Dynamic Hedging Framework for Institutional Investors requires registration with the Bank either by the Resident Entity or the Principal.'},
      {ref:'Part A, fn. 3 (Para 3)',title:'Non-Resident Principal — Dynamic Hedging registration (cross-reference)',body:'Refer to footnote 2 (see "Part A, fn. 2 (Para 3)"): where the Principal is a Non-Resident under paragraph 3(c), a transaction undertaken pursuant to the Dynamic Hedging Framework for Institutional Investors requires registration with the Bank either by the Resident Entity or the Principal.'},
      {ref:'Part A, Para 4',title:'Resident Intermediary — buying/selling FCY vs Ringgit on behalf of clients',body:'A Resident Intermediary acting on behalf of a Resident or Non-Resident client is allowed to buy or sell Foreign Currency against Ringgit with a LOB for settlement of a Ringgit Asset or Foreign Currency Asset, provided that: (a) where the client is a Resident, the transaction complies with paragraph 1; and (b) where the client is a Non-Resident, the transaction complies with paragraph 6.'},
      ...
      {ref:'Part A, Para 2(2)',title:'Resident Institutional Investor — unwind of Dynamic Hedging forward contract',body:'The Resident Institutional Investor is allowed to unwind the plain vanilla forward contract undertaken in accordance with paragraph 2(1) with any LOB.'},
      ...
      {ref:'Part B, Para 6(2)',title:'Non-Resident — unwind of Forward Basis (Portfolio Investment exception)',body:'A Non-Resident is allowed to unwind a Forward Basis transaction undertaken in accordance with paragraph 6(1)(b) with any LOB or AOO, EXCEPT for a transaction where the Firm Commitment is a Portfolio Investment.'},
      {ref:'Part B, Para 12',title:'Non-Resident — Forward Basis restrictions and exclusions',body:'For Non-Residents, the terms "Forward Basis" or "plain vanilla forward contract" (Paras 6–11): INCLUDE buying/selling involving Ringgit deposit in a Non-Resident\'s External Account where BOTH conditions are met — (i) such deposit does not exceed 3 months and arises from sale of a Ringgit Asset prior to the forward maturity date; AND (ii) the total transaction amount does not exceed the total value of the Non-Resident\'s Ringgit Assets (including proceeds from disposal of and income from the Ringgit Asset deposited in the External Account). EXCLUDE buying/selling of FCY against Ringgit: (i) for settlement of Ringgit negotiable instrument of deposits; (ii) involving an External Account EXCEPT for the Ringgit funds described in the INCLUDE condition above; or (iii) for settlement of OTC derivatives or structured products tantamount to Borrowing or lending of Ringgit between a Resident and a Non-Resident.'},
      ...
      {ref:'Part B, Para 7(2)',title:'Non-Resident Institutional Investor — unwind of Dynamic Hedging forward contract',body:'The Non-Resident Institutional Investor is allowed to unwind the plain vanilla forward contract undertaken in accordance with paragraph 7(1) with any LOB or AOO.'},
      {ref:'Part B, fn. 4 (Para 8)',title:'Dynamic Hedging registration — Non-Resident Entity transacting for the Principal',body:'A transaction that is undertaken pursuant to the Dynamic Hedging Framework for Institutional Investors requires registration with the Bank either by the Non-Resident Entity or the Principal.'},
      {ref:'Part B, fn. 5 (Para 8)',title:'Non-Resident Principal — Dynamic Hedging registration (cross-reference)',body:'Refer to footnote 4 (see "Part B, fn. 4 (Para 8)"): where the Principal is a Non-Resident under paragraph 8(c), a transaction undertaken pursuant to the Dynamic Hedging Framework for Institutional Investors requires registration with the Bank either by the Non-Resident Entity or the Principal.'},
      {ref:'Part B, Para 8',title:'Non-Resident Entity — buying/selling FCY vs Ringgit on behalf of Group entities',body:'A Non-Resident Entity is allowed to buy or sell Foreign Currency against Ringgit on behalf of an Entity within its Group ("the Principal") with a LOB or an AOO, provided that: (a) the Principal is not a Financial Institution or NRFI; (b) where the Principal is a Resident, the Principal complies with paragraphs 1 and 2; and (c) where the Principal is a Non-Resident, the Principal complies with paragraphs 6 and 7.'},
      {ref:'Part B, Para 9',title:'Non-Resident Intermediary — buying/selling FCY vs Ringgit on behalf of clients',body:'A Non-Resident Intermediary acting on behalf of a Resident or Non-Resident client is allowed to buy or sell Foreign Currency against Ringgit with a LOB or an AOO for settlement of a Ringgit Asset or Foreign Currency Asset, provided that: (a) where the client is a Resident, the transaction complies with paragraph 1; (b) where the client is a Non-Resident, the transaction complies with paragraph 6; and (c) the Non-Resident Intermediary complies with paragraph 11 of Notice 4 for transactions undertaken for settlement of a Ringgit Asset only.'},
      {ref:'Part B, Para 10',title:'NRFI — buying/selling FCY vs Ringgit on behalf of Non-Resident client for international trade',body:'A NRFI, acting on behalf of a Non-Resident client, is allowed to buy or sell Foreign Currency against Ringgit for settlement of international trade in goods or services with a Resident on Spot Basis or Forward Basis (subject to paragraph 12(b)(ii)) with a LOB or an AOO on Firm Commitment basis, provided that the NRFI complies with paragraphs 10 and 12 of Notice 4.'},
      {ref:'Part B, Para 11(1)-(2)',title:'NRFI as custodian/trustee — buying/selling FCY vs Ringgit for Ringgit Asset settlement',body:'A NRFI acting as a custodian or trustee managing Ringgit Asset for its Resident or Non-Resident client with Ringgit Asset custody relationship is allowed to buy or sell Foreign Currency against Ringgit with a LOB or an AOO for settlement of a Ringgit Asset, provided that: (a) where the client is a Resident, the transaction complies with paragraph 1; (b) where the client is a Non-Resident, the transaction complies with paragraph 6; and (c) the NRFI is registered with the Bank for a transaction undertaken with an AOO — registration by submitting the NRFI Custody Passive Foreign Exchange Transaction Registration Form available at https://bnm.my/fep; the Bank shall notify the NRFI in writing upon acceptance. The approval includes buying or selling FCY against Ringgit for settlement of a Ringgit Asset that may not be under the NRFI\'s own custody.'},
      {ref:'Part B, fn. 6 (Para 11)',title:'NRFI custodian — FX for Ringgit Asset that may not be under custody (illustration)',body:'For example: Global Custodian A holds Ringgit-denominated equities and Global Custodian B holds Ringgit-denominated bonds under custody for a Non-Resident Client. Global Custodian A is allowed to undertake a foreign exchange transaction for both underlying Ringgit-denominated equities and Ringgit-denominated bonds on behalf of the Non-Resident Client.'},
      {ref:'Part C, Para 14',title:'Licensed Money Changer — dealings (client perspective)',body:'A Resident or Non-Resident is allowed to buy or sell Foreign Currency against Ringgit or against another Foreign Currency on Spot Basis with a Licensed Money Changer in accordance with the MSBA.'},
      {ref:'Part C, Para 15',title:'Licensed Money Changer — own permission to buy/sell with clients',body:'A Licensed Money Changer is allowed to buy or sell: (a) Foreign Currency against Ringgit; or (b) Foreign Currency against another Foreign Currency, on Spot Basis with its Resident or Non-Resident clients in accordance with the MSBA.'},
      {ref:'Part D, Para 16',title:'Gold and Precious Metals',body:'A person is allowed to: (a) buy, sell, exchange, borrow, lend, retain or use gold or other precious metals — subject to compliance with section 137 of the FSA, section 149 of the IFSA and Parts B and C of Notice 4; (b) import gold or other precious metals; or (c) export gold or other precious metals — subject to compliance with Notice 7.'},
      {ref:'Part E, Para 17',title:'MSBA licensee — information publishing on currency dealings',body:'A licensee under the MSBA is allowed to issue, publish or disseminate information in any form on buying, selling and exchanging of Foreign Currency in accordance with Parts A and B of this Notice.'},
      {ref:'Part E, Para 18',title:'Person — information publishing on gold and precious metals dealings',body:'A person is allowed to issue, publish or disseminate information in any form on buying, selling, exchanging, Borrowing, lending, retaining or using of gold and other precious metals, subject to compliance with section 137 of the FSA, section 149 of the IFSA and Parts B and C of Notice 4.'},
    ],
    ...
    faqs: [
      { subcategory:'Buying and Selling of Foreign Exchange (FX) by Resident', items: [
      ...
      { subcategory:'Buying and Selling of Foreign Exchange (FX) by Non-Resident', items: [
        {ref:'FAQ Q1',title:'Who can a Non-Resident buy or sell ringgit against FC with to hedge its ringgit exposure?',body:'A Non-Resident may buy or sell ringgit against FC with any licensed onshore bank or an appointed overseas office (AOO), on: (i) a Spot Basis; or (ii) a Forward Basis for Current Account Transactions on a Firm Commitment or Anticipatory basis, or Financial Account Transactions on a Firm Commitment basis. An AOO is an overseas outfit of a licensed onshore bank\'s banking group appointed by that bank to facilitate ringgit transactions.'},
        {ref:'FAQ Q2',title:'What proof of underlying is needed to support FX hedging on an Anticipatory basis via an AOO by a Non-Resident?',body:'The proof of underlying is determined by the respective AOO and licensed onshore bank\'s customer due diligence (CDD) process, which includes verifying the Non-Resident\'s projected transaction against its previous track record. Further detail is set out in the Minimum Due Diligence for FX Transactions issued by the banking industry.'},
        {ref:'FAQ Q3',title:'Can a Non-Resident unwind a forward contract entered on an Anticipatory basis if its value exceeds the Firm underlying amount?',body:'Yes. Alternatively, the Non-Resident may roll over the contract to cover its other underlying commitments.'},
        {ref:'FAQ Q4',title:'How should a trust bank or global custodian undertake FX trades involving ringgit on behalf of its clients?',body:'All FX trades involving ringgit on behalf of clients must be conducted on a gross basis with a licensed onshore bank or an AOO.'},
        {ref:'FAQ Q5',title:'Can a Non-Resident freely cancel or unwind a forward contract if the underlying ringgit Borrowing has not been fully repaid?',body:'Yes. There is no restriction on cancelling or unwinding a forward contract involving ringgit where the underlying commitment still exists, provided the underlying is not in the form of portfolio investment.'},
        {ref:'FAQ Q6',title:'Is there a limit or threshold on the forward contracts a Non-Resident can cancel or unwind?',body:'No, but a Non-Resident should use this flexibility to manage its FX risk prudently.'},
        {ref:'FAQ Q7',title:'Can a Non-Resident unwind an existing forward contract by entering into an opposite forward contract without an underlying?',body:'Yes, provided the licensed onshore bank or AOO is satisfied that the new forward contract is entered to cancel an existing forward contract with an underlying commitment.'},
        {ref:'FAQ Q8',title:'Can a Non-Resident unwind its forward position with a different licensed onshore bank or AOO?',body:'Yes, provided the licensed onshore bank or AOO is satisfied that the forward contract is entered to cancel an existing forward contract with an underlying.'},
        {ref:'FAQ Q9',title:'Can a Non-Resident Institutional Investor cancel or unwind forward contracts hedging FX risk from portfolio investment?',body:'Yes, once the Non-Resident Institutional Investor has registered with BNM under the Dynamic Hedging Framework.'},
        {ref:'FAQ Q10',title:'What FX hedging is permitted for commodity derivative contracts offered by a Resident provider to a Non-Resident?',body:'Where a Non-Resident has FX exposure from contracting ringgit-denominated commodity derivatives that involve physical settlement on maturity, it may hedge up to the net open position (NOP) of the FX exposure arising from those derivative contracts. This covers any derivative (other than exchange rate derivatives) denominated in ringgit that is traded on Bursa Malaysia (e.g. Crude Palm Oil Futures (FCPO) and Options on Crude Palm Oil Futures (OCPO)) or offered over-the-counter (OTC) by approved Resident providers.'},
        {ref:'FAQ Q11',title:'Must a Non-Resident observe the NOP requirement for commodity derivative hedging on an intra-day basis?',body:'No, the NOP requirement applies at the end of the business day, consistent with international standards. If the FX market has already closed, any over-hedged position must be unwound at the earliest possible time.'},
        {ref:'FAQ Q12',title:'Is documentation required upfront if a commodity derivative service provider or broker cannot promptly provide a statement of derivative contract positions?',body:'No, documentation may be produced after the transaction, subject to the licensed onshore bank\'s KYC procedures.'},
        {ref:'FAQ Q13',title:'Is the NOP for commodity derivative hedging computed on an aggregate basis across all underlying derivative contracts with a Resident?',body:'No, the NOP is computed separately based on the respective types of derivative contracts.'},
        {ref:'FAQ Q14',title:'Can a Non-Resident entity undertake FX transactions on behalf of its Resident and Non-Resident entities within the same Group?',body:'Yes, a Non-Resident entity may undertake FX transactions for FX exposures with a licensed onshore bank or an AOO on behalf of its Resident or Non-Resident entities within the same Group.'},
        {ref:'FAQ Q15',title:'What types of underlying FX exposures can a Non-Resident entity manage on behalf of Group entities?',body:'Any FX exposure arising from permitted underlying commitments belonging to the entities within the same Group.'},
        {ref:'FAQ Q16',title:'Who is eligible for the Dynamic Hedging Framework as a Non-Resident Institutional Entity?',body:'A Non-Resident Institutional Investor that registers with BNM, excluding (a) a Non-Resident bank and (b) a Non-Resident securities company; registration must be undertaken at firm level. A Non-Resident trust bank or custodian bank may also register on behalf of its Non-Resident Institutional Investor clients.'},
        {ref:'FAQ Q17',title:'How does a Non-Resident Institutional Investor register for the Dynamic Hedging Framework?',body:'If not already registered, the Non-Resident Institutional Investor must complete a one-off registration with BNM. The form is available on BNM\'s website, http://bnm.my/fep.'},
        {ref:'FAQ Q18',title:'How does a Non-Resident trust bank or global custodian apply for the Dynamic Hedging Framework?',body:'A Non-Resident trust bank or global custodian may submit an application to undertake dynamic hedging on behalf of its Non-Resident Institutional Investor clients. The form is available on BNM\'s website, http://bnm.my/fep.'},
        {ref:'FAQ Q19',title:'Can a Non-Resident Institutional Investor carve out specific funds for passive hedging during registration?',body:'Yes. During registration, the Non-Resident Institutional Investor must make a one-off declaration of the funds to be used for dynamic hedging. Funds carved out for passive hedging are not eligible for dynamic hedging.'},
        {ref:'FAQ Q20',title:'What hedging instruments are permitted under the Dynamic Hedging Framework for Non-Residents?',body:'Only plain vanilla FX/MYR forward contracts (buying or selling) are permitted as the hedging instrument.'},
        {ref:'FAQ Q21',title:'What underlying assets are eligible for dynamic hedging by a Non-Resident Institutional Investor?',body:'(a) Investment in ringgit-denominated debt securities on the Real-time Electronic Transfer of Funds and Securities System (RENTAS); (b) investment in ringgit-denominated equity securities on Bursa Malaysia; or (c) temporary placement in ringgit deposits or deposit-like securities offered by licensed onshore banks, using ringgit proceeds from the sale of the securities in (a) or (b), for up to 3 months.'},
        {ref:'FAQ Q22',title:'What is the permitted threshold for dynamic hedging by a Non-Resident Institutional Investor?',body:'A Non-Resident Institutional Investor registered with BNM may: (a) enter into forward contracts to sell ringgit against FC up to 100% of its invested underlying Ringgit Asset; (b) enter into forward contracts to buy ringgit against FC up to 25% of its invested underlying Ringgit Asset; or (c) unwind the forward contracts described in (a) and (b).'},
        {ref:'FAQ Q23',title:'What happens if a Non-Resident Institutional Investor breaches the permitted dynamic hedging threshold?',body:'The Non-Resident Institutional Investor must unwind the forward position back to the permitted limit. BNM will advise the permitted timeline for unwinding on a case-by-case basis (within 7 business days); failure to comply may result in BNM reviewing the investor\'s eligibility.'},
        {ref:'FAQ Q24',title:'Can a Non-Resident Institutional Investor apply for additional flexibility beyond the 25% threshold?',body:'Yes. A registered Non-Resident Institutional Investor wishing to enter into forward contracts to buy ringgit against FC beyond the existing 25% threshold may submit an application to BNM via email to investorregister@bnm.gov.my, justifying the need for the additional position.'},
        {ref:'FAQ Q25',title:'Can a Non-Resident Institutional Investor net settle a forward transaction in FC?',body:'Yes, settlement of forward transactions may be done on a gross or net basis.'},
        {ref:'FAQ Q26',title:'Who can a Non-Resident Institutional Investor approach to undertake dynamic hedging?',body:'A registered Non-Resident Institutional Investor may approach a licensed onshore bank or an AOO to undertake dynamic hedging.'},
        {ref:'FAQ Q27',title:'Can a Non-Resident Institutional Investor use its existing Legal Entity Identifier (LEI) to register for dynamic hedging?',body:'Yes, a Non-Resident Institutional Investor should use its existing LEI to register. More information on the LEI is available at https://www.leiroc.org/.'},
        {ref:'FAQ Q28',title:'Can a Non-Resident transact ringgit interest rate derivatives directly with an LOB or via an AOO?',body:'Yes, such ringgit interest rate derivatives may be undertaken with or without an underlying ringgit interest rate exposure. Effective 15 March 2021, Non-Resident banks may trade ringgit-denominated interest rate swaps without an underlying commitment with any licensed onshore bank, including via its AOO. However, any ringgit interest rate derivative embedded with buying and selling of ringgit against FC (for example, a cross-currency interest rate swap) must be undertaken with a Firm underlying commitment.'},
        {ref:'FAQ Q29',title:'Can a Non-Resident settle a ringgit interest rate derivative contract with an LOB or AOO in ringgit or FC?',body:'Yes, settlement with an LOB or AOO may be done in either ringgit or FC, and on a gross or net basis. For settlement in ringgit or FC, an LOB shall use only the reference exchange rate fixed in Malaysia.'},
      ] },
    ] },
  2: { id:2, short:'N2', icon:'ti-building-bank', title:'Borrowing, Lending and Guarantee',
    ...
    secs: [
      ...
      {ref:'Part A, fn. 1 (Para 2)',title:'RM1 million Ringgit borrowing limit — aggregation basis',body:'Computed based on an aggregate of Borrowing in Ringgit by the Resident Individual and a sole proprietor and a General Partnership owned by the Resident Individual.'},
      ...
      {ref:'Part A, fn. 2 (Para 4)',title:'RM10 million FCY borrowing limit — aggregation basis',body:'Computed based on an aggregate of Borrowing in Foreign Currency by the Resident Individual and a sole proprietor and a General Partnership owned by the Resident Individual.'},
      {ref:'Part A, Para 5',title:'Resident Individual/Sole Prop/GP — refinancing of Borrowing',body:'A Resident Individual, sole proprietor or General Partnership is allowed to refinance the outstanding approved Borrowing (including principal and accrued interest or profit) as per paragraphs 1 to 4, subject to compliance with the requirements in the respective paragraph.'},
      ...
      {ref:'Part B, fn. 3 (Para 8)',title:'RM1 million Ringgit entity borrowing limit — aggregation basis',body:'Computed based on an aggregate Borrowing in Ringgit by the Resident Entity and other Resident Entity with Parent-Subsidiary Relationship.'},
      {ref:'Part B, Para 9',title:'Resident Entity — FCY borrowing unlimited from LOB, Group, or Direct Shareholder (with NRFI/SPV exception)',body:'A Resident Entity is allowed to borrow in Foreign Currency in any amount from: (a) a LOB; (b) an Entity within the Resident Entity\'s Group or from the Resident Entity\'s Direct Shareholder — EXCEPT for an Entity stated in paragraph 10(b) (a NRFI) or 10(c) (a Non-Resident SPV used to obtain Borrowing from outside the Group); those are capped at RM100 million under Para 10; or (c) through issuance of Foreign Currency Corporate Bond or Sukuk to another Resident — subscription of the Corporate Bond or Sukuk by the latter shall be subject to compliance with Notice 3.'},
      ...
      {ref:'Part B, fn. 4 (Para 10)',title:'RM100 million FCY entity borrowing limit — aggregation basis',body:'Computed based on an aggregate Borrowing in Foreign Currency by the Resident Entity and other Resident Entity with Parent-Subsidiary Relationship.'},
      {ref:'Part B, Para 11',title:'Resident Entity — refinancing of Borrowing',body:'A Resident Entity is allowed to refinance the outstanding approved Borrowing (including principal and accrued interest or profit) as per paragraphs 6 to 10, subject to compliance with the requirements in the respective paragraph.'},
      {ref:'Part C, Para 12',title:'Exchanging of Ringgit or Foreign Currency debt (debt swap)',body:'A Resident is allowed to exchange (swap) its existing Ringgit or Foreign Currency debt for another debt, per the Appendix: WITH A LOB — swapping Ringgit debt into FCY debt (with/without delivery of FCY at inception) is treated as FCY Borrowing, and any FCY delivered at inception used for investment in FCY Asset must comply with Notice 3 for a Resident with DRB; swapping FCY debt into Ringgit debt (with/without delivery of Ringgit at inception) is treated as Domestic Ringgit Borrowing — if the original FCY Borrowing was from a Non-Resident, it remains subject to Notice 2 Parts A/B. WITH A NON-RESIDENT — swapping FCY debt into another FCY debt (with/without delivery of FCY at inception) is treated as FCY Borrowing from a Non-Resident, subject to Notice 2 Parts A/B.'},
      ...
      {ref:'Part D, fn. 5 (Para 14)',title:'Ringgit borrowing for Real Sector Activity — includes refinancing',body:'Includes refinancing of existing Borrowing in Ringgit that was used for Real Sector Activity in Malaysia or on-lending in Ringgit (Refer to FAQ for more details).'},
      {ref:'Part D, Para 15',title:'Multilateral Development Bank/Qualified DFI — Ringgit borrowing through debt security issuance',body:'A Multilateral Development Bank or Qualified Development Financial Institution is allowed to borrow in Ringgit in any amount for use in Malaysia, from a Resident and Non-Resident, through the issuance of a debt security denominated in Ringgit.'},
      ...
      {ref:'Part E, Para 18',title:'Person — information publishing on Borrowing',body:'Any person is allowed to issue, publish or disseminate information in any form or advertisements which may lead, directly or indirectly, to any transaction allowed under this Notice or Part A of Notice 5.'},
      ...
      {ref:'Part G, fn. 6 (Para 22)',title:'Financial Guarantee — meaning of "call-upon"',body:'A "call-upon" of Financial Guarantee shall be initiated by the lender in writing to the guarantor. A guarantor may not initiate a "call-upon" of a Financial Guarantee. In the event a Financial Guarantee is liquidated at the instruction of the guarantor, the guarantor must obtain prior approval from the Bank in accordance with Notice 3.'},
      {ref:'Part G, fn. 7 (Para 22)',title:'Financial Guarantee — event of default before call-upon',body:'An event of default prior to a call-upon of a Financial Guarantee by the lender shall be treated by the lender in accordance with the requirements under IFRS9 or any equivalent accounting standards adopted by the lender.'},
      {ref:'Part G, Para 23',title:'Resident lender — obtaining guarantee from Non-Resident',body:'A Resident lender is allowed to obtain a Financial Guarantee in any amount in FCY or Ringgit from a Non-Resident guarantor to secure a Borrowing obtained by a Resident or Non-Resident borrower. Where the underlying Borrowing obtained by a Resident is approved under this Notice (or otherwise approved in writing by the FEP Authority), the Financial Guarantee securing it is deemed approved.'},
      {ref:'Part G, Para 24',title:'Financial Guarantee — currency of payment',body:'(1) Any payment arising from a Financial Guarantee in Foreign Currency between Residents shall be made in Ringgit — UNLESS the Resident guarantor is: (a) an Entity within the borrower\'s Group; (b) the borrower\'s Direct Shareholder; (c) an Immediate Family Member; or (d) a LOB — in which case payment may be made in Ringgit or Foreign Currency. (2) Any payment arising from a Financial Guarantee made TO a Non-Resident lender shall be in Foreign Currency, EXCEPT a Non-Resident guarantor may pay a Resident lender in Ringgit or FCY for a Ringgit Financial Guarantee securing approved Ringgit Borrowing. (3) Repayment of consequential debt arising from a Financial Guarantee to a Non-Resident guarantor shall only be made in Foreign Currency.'},
      ...
      {ref:'Part G, Para 26',title:'Non-Financial Guarantee — currency of payment',body:'Any payment to a Non-Resident under a Non-Financial Guarantee shall be made in Foreign Currency. HOWEVER, a payment to or from a Non-Resident under a Non-Financial Guarantee in Ringgit FOR USE IN MALAYSIA may be made in Ringgit or Foreign Currency.'},
    ],
    kw:['borrow','borrowing','lend','lending','loan','guarantee','financial guarantee','non-financial guarantee','performance bond','RM10 million','RM100 million','RM1 million','NRFI','SPV','group','direct shareholder','trade financing','real sector','refinance','immediate family','LOB','credit facility','call-upon','covenant to pay','event of default','IFRS9','debt swap','exchange of debt'],
    faqs: [
      { subcategory:'Borrowing by Resident', items: [
      ...
      { subcategory:'Guarantee by Resident', items: [
        {ref:'FAQ Q1',title:'Can a Resident entity or individual freely obtain a Financial Guarantee (FG) from any Non-Resident, including a NRFI?',body:'Yes, there is no approval or registration requirement for a Resident to obtain a Financial Guarantee from any Non-Resident, including a Non-Resident Financial Institution (NRFI).'},
        {ref:'FAQ Q2',title:'Can a Resident freely give a Financial Guarantee on behalf of or in favour of a Non-Resident?',body:'Yes, except for a Financial Guarantee issued to secure: (a) FC Borrowing obtained by a Non-Resident SPV from a Non-Resident entity outside the Resident guarantor\'s Group, or where the underlying Borrowing is ultimately utilised by the Resident guarantor — this is deemed Borrowing by the Resident guarantor, subject to the external borrowing limits under Notice 2 Parts A/B; or (b) FC Borrowing obtained by a Non-Resident where repayment will be made by a Resident other than when the FG is called upon by the lender in the event of default — this is deemed an investment in FC Asset, subject to the Notice 3 limit.'},
        {ref:'FAQ Q3',title:'Is BNM approval required to issue a FG securing FC borrowing by a Non-Resident SPV where the proceeds are used by another Non-Resident entity in the same group?',body:'Yes, approval from BNM is required based on the external borrowing limit under Notice 2, even if the Resident guarantor is not the beneficiary of the FC Borrowing.'},
        {ref:'FAQ Q4',title:'Does a Resident guarantor need BNM approval for changes to an existing registered or approved FG?',body:'No, except for FGs securing FC Borrowing obtained by a Non-Resident SPV from outside the Resident guarantor\'s Group, where the underlying Borrowing is ultimately utilised by the Resident guarantor, or where repayment will be made by a Resident (other than upon a call-upon in the event of default) — in those cases the Resident guarantor must abide by the conditions in the approval letter.'},
        {ref:'FAQ Q5',title:'Does a "Covenant to Pay" clause (where the guarantor must repay/service FC borrowing without an event of default) count as an arrangement to repay the borrowing?',body:'Yes. This is regarded as the Resident having an obligation to repay the FC Borrowing on behalf of the Non-Resident borrower, and is subject to the investment in FC asset limit under Notice 3.'},
        {ref:'FAQ Q6',title:'If a Resident gives a FG to a Non-Resident Group entity (not a SPV) where the borrowing proceeds will be on-lent to another Resident within the group, is BNM approval required?',body:'No, this is freely allowed — UNLESS there is a formal or informal arrangement for the Resident guarantor to service or repay the FC Borrowing other than for an event of default, in which case the FG is subject to the investment in FC asset limit under Notice 3.'},
        {ref:'FAQ Q7',title:'Is a guarantee securing payment of trade in goods (a trade guarantee) deemed a Financial Guarantee?',body:'No, a guarantee to secure payment of trade in goods is deemed as Borrowing, not a Financial Guarantee.'},
        {ref:'FAQ Q8',title:'What qualifies as a "call-upon" of a Financial Guarantee in the event of default?',body:'A "call-upon" of a Financial Guarantee must be initiated by the LENDER in writing to the guarantor. A guarantor may NOT initiate a "call-upon" of a Financial Guarantee.'},
        {ref:'FAQ Q9',title:'Can a Resident guarantor instruct the liquidation of a FG to voluntarily repay the borrowing on behalf of the borrower?',body:'A guarantor may not initiate a "call-upon" of a FG. In the event a guarantor intends to voluntarily liquidate a FG to support the borrower, the guarantor must obtain prior approval from BNM in accordance with Notice 3.'},
        {ref:'FAQ Q10',title:'What is considered an "event of default" for FG rules?',body:'An event of default, prior to a call-upon of a Financial Guarantee by the lender, shall be treated by the lender in accordance with the requirements under IFRS 9 or any equivalent accounting standards adopted by the lender.'},
        {ref:'FAQ Q11',title:'Can a Resident issue or obtain a Non-Financial Guarantee (NFG) in FC to or from another Resident?',body:'Yes, a NFG between Residents is allowed. However, any payment arising from the NFG between the two Residents must be made in Ringgit only.'},
        {ref:'FAQ Q12',title:'Can a Resident pay in Ringgit to a Non-Resident guarantor arising from a called-upon NFG denominated in Ringgit?',body:'Yes, provided the NFG was issued for use in Malaysia and the Ringgit payment is credited into the Non-Resident guarantor\'s External Account. Utilisation of the Ringgit funds in that External Account must comply with Notice 4.'},
      ] },
      { subcategory:'Borrowing in Malaysia by Non-Resident', items: [
        {ref:'FAQ Q1',title:'Can a Non-Resident individual borrow in Ringgit from their Non-Resident sibling for any purpose?',body:'Yes. A Non-Resident individual may borrow any amount in Ringgit or FC from a Resident or Non-Resident Immediate Family Member (i.e. spouse, parents, children and siblings) for any purpose.'},
        {ref:'FAQ Q2',title:'Can a Non-Resident individual borrow in Ringgit from a Non-Resident sister-in-law for any purpose?',body:'No. In-laws are not treated as Immediate Family Members, so this Borrowing is not permitted under the Immediate Family Member exemption.'},
        {ref:'FAQ Q3',title:'Can a Non-Resident obtain a Ringgit margin financing facility from a Resident stockbroking company to buy Bursa Malaysia-listed shares?',body:'Yes, this is permitted.'},
        {ref:'FAQ Q4',title:'From which sources can a Non-Resident individual borrow Ringgit in Malaysia for any purpose?',body:'A Non-Resident individual may borrow Ringgit up to any amount from: (i) an Immediate Family Member; (ii) a licensed insurer or licensed takaful operator, in connection with a life insurance policy or family takaful certificate; or (iii) an employer in Malaysia, for domestic use. Separately, a Non-Resident individual may also obtain a credit card or charge card facility from an onshore bank for payment of retail goods or services while abroad.'},
        {ref:'FAQ Q5',title:'Can a Non-Resident (other than a NRFI) borrow in Ringgit to finance Real Sector Activity in Malaysia, including buying property?',body:'Yes. A Non-Resident, excluding a NRFI, may borrow Ringgit up to any amount to finance Real Sector Activity in Malaysia, including the purchase of immovable property — except where the purchase is of land only.'},
        {ref:'FAQ Q6',title:'What Ringgit borrowing exceptions apply for margin financing and for a Multilateral Development Bank or Qualified Development Financial Institution?',body:'Notwithstanding the general Real Sector Activity rule: (i) a Non-Resident is allowed to obtain margin financing from a Resident holding a stockbroking licence under the Capital Markets and Services Act 2007, for products traded on Bursa Malaysia; and (ii) a Multilateral Development Bank or a Qualified Development Financial Institution is allowed to borrow Ringgit for use in Malaysia from a Resident or Non-Resident through the issuance of a Ringgit-denominated debt security.'},
        {ref:'FAQ Q7',title:'On what basis can a Non-Resident borrow Ringgit from a LOB?',body:'A Non-Resident may borrow Ringgit from a LOB: (i) via trade financing, for settlement of trade with a Resident, up to any amount; (ii) via an overdraft facility to avoid settlement failure on the purchase of shares or Ringgit instruments traded on Bursa Malaysia or through RENTAS — this overdraft flexibility may only be used by a Non-Resident custodian bank, stockbroking corporation, trust bank, central securities depository or international securities depository acting on behalf of clients, or by a Non-Resident investor for its own account; or (iii) up to RM10 million in aggregate via a repurchase agreement or sale-and-buy-back agreement. Refer to Notice 2 for further details.'},
        {ref:'FAQ Q8',title:'What activities count as Real Sector Activity for Non-Resident Ringgit borrowing, and what does not?',body:'Real Sector Activity includes use of Borrowing proceeds to ultimately finance a Real Sector Activity in Malaysia, such as refinancing of existing Borrowing, on-lending in Ringgit, direct investment and capital contribution. Non-real sector activities include the provision of financial services in Malaysia, or use of the funds outside Malaysia.'},
        {ref:'FAQ Q9',title:'What is a Qualified Development Financial Institution for Non-Resident borrowing purposes?',body:'A Qualified Development Financial Institution is a Non-Resident Development Financial Institution approved by BNM. The list of approved Qualified Development Financial Institutions is published on BNM\'s website (bnm.gov.my/fep).'},
      ] },
    ] },
  3: { id:3, short:'N3', icon:'ti-chart-line', title:'Investment in Foreign Currency Asset',
    ...
    secs: [
      ...
      {ref:'Part A, fn. 1 (Para 2)',title:'Real estate abroad — own or Immediate Family Member accommodation only',body:'The real estate is for the Resident Individual\'s own accommodation or the Resident Individual\'s Immediate Family Member\'s accommodation only.'},
      {ref:'Part A, fn. 2 (Para 2)',title:'Individual FCY Asset investment limit — aggregation basis',body:'Computed in aggregate based on the Resident Individual, sole proprietorship and General Partnership\'s investment in Foreign Currency Asset.'},
      ...
      {ref:'Part B, fn. 3 (Para 4)',title:'Entity FCY Asset investment limit — aggregation basis',body:'Computed in aggregate based on the Resident Entity and other Resident Entity with Parent-Subsidiary Relationship\'s investment in Foreign Currency Asset.'},
      ...
      {ref:'Part C, Para 6',title:'Licensed insurer, takaful operator or SC-licensed Entity — investing Onshore on behalf of clients UNLIMITED',body:'A licensed insurer, a licensed takaful operator, or a Resident Entity authorised, registered or licensed by the Securities Commission Malaysia (including a Resident Entity offering closed-end funds) to undertake investment on behalf of its clients, may invest in Foreign Currency Asset ONSHORE on behalf of its clients up to ANY amount.'},
      {ref:'Part C, fn. 4 (Para 6)',title:'SC-licensed Entity — includes closed-end funds',body:'Including a Resident Entity offering closed-end funds.'},
      {ref:'Part C, Para 7-8',title:'Licensed insurer / takaful operator — investing Offshore on behalf of clients (NAV limits)',body:'A licensed insurer is allowed to invest in Foreign Currency Asset Offshore on behalf of its client up to: (a) the NAV of an investment-linked fund belonging to a client who is a Resident without DRB or a Non-Resident; or (b) 50% of the NAV (computed in aggregate at the licensed insurer\'s level, not per fund) of an investment-linked fund belonging to its Resident client WITH DRB — UNLESS the licensed insurer can ascertain that paragraph 2(a), 2(c)(i)-(ii), 4(a) or 4(c)(i)-(iii) applies, in which case the higher limits under those paragraphs apply instead. A licensed takaful operator is allowed to invest in Foreign Currency Asset Offshore on behalf of its clients up to the NAV of a Shariah-compliant investment-linked fund belonging to its client.'},
      {ref:'Part C, fn. 5 (Para 7)',title:'Insurer 50% NAV limit — aggregation basis',body:'Computed in aggregate at the licensed insurer\'s level instead of on per fund basis.'},
      {ref:'Part C, Para 9-10',title:'SC-licensed fund manager — investing Offshore on behalf of clients (NAV limits, with exceptions)',body:'A Resident Entity authorised, registered or licensed by the Securities Commission Malaysia to offer a unit trust scheme or collective investment scheme (including a closed-end fund) is allowed to invest in FCY Asset Offshore on behalf of its client up to: (a) the NAV of funds belonging to a client who is a Resident without DRB or a Non-Resident; (b) the NAV of Shariah-compliant funds belonging to its Resident client; or (c) 50% of the NAV (computed in aggregate at the Resident Entity\'s level, not per fund) of conventional funds belonging to its Resident client WITH DRB — UNLESS the Resident Entity can ascertain that paragraph 2(a), 2(c)(i)-(ii), 4(a) or 4(c)(i)-(iii) applies. (10)(1) A Resident Entity licensed by SC Malaysia to undertake fund management activities is allowed to invest in FCY Asset Offshore on behalf of its client up to: (a) the total funds belonging to a client who is a Resident without DRB or a Non-Resident; (b) the total funds belonging to its Resident client for investment in Shariah-compliant assets; or (c) 50% of the total funds (computed in aggregate at the Resident Entity\'s level) belonging to its Resident client WITH DRB — unless the same exceptions apply. (2) Where decisions on the investment under paragraph 10(1) are made by the Resident CLIENT itself (not the fund manager), Parts A and B of this Notice shall apply directly to that client instead.'},
      {ref:'Part C, fn. 6-7 (Para 9-10)',title:'Fund manager 50% NAV limit — aggregation basis',body:'Computed in aggregate at the Resident Entity\'s level instead of on per fund basis.'},
    ],
    kw:['invest','investment','foreign currency asset','FCY asset','offshore','onshore','domestic ringgit borrowing','DRB','RM1 million','RM50 million','LOB','unit trust','direct investment abroad','DIA','real estate','Trade FCA','unlimited','fund manager','portfolio','securities','investment-linked fund','net asset value','NAV','licensed insurer','takaful operator','closed-end fund','fund management'],
    faqs: [
      { subcategory:'Investing in Foreign Currency Asset by Resident', items: [
      ...
      { subcategory:'Investing in Malaysia by Non-Resident', items: [
        {ref:'FAQ Q1',title:'Is there any restriction on a Non-Resident investing in Malaysia and repatriating profits or divestment proceeds abroad?',body:'No. A Non-Resident is free to invest in any form of Ringgit Asset in Malaysia, and is also free to repatriate divestment proceeds, profits, dividends or any income arising from these investments in Malaysia, provided it is in Foreign Currency (FC).'},
        {ref:'FAQ Q2',title:'I am a Non-Resident overseas and want to buy Ringgit assets but can\'t access Malaysian financial markets due to time zone differences - can I buy Ringgit from a financial institution in my home country?',body:'Yes. A Non-Resident investor may buy Ringgit against FC from an appointed overseas office (AOO) of a licensed onshore bank to facilitate the purchase of Ringgit Asset. A list of financial institutions under the AOO framework is available at https://bnm.my/fep.'},
        {ref:'FAQ Q3',title:'Can a Non-Resident open a Ringgit account in Malaysia, and are there restrictions on how it can be operated?',body:'Yes. A Non-Resident is free to open a Ringgit account in Malaysia, known as an External Account. Funds in the External Account can be used, among others, to pay for goods or services in Malaysia or to purchase Ringgit Asset in Malaysia. There is also no restriction on a Non-Resident repatriating funds in the External Account upon conversion into FC.'},
        {ref:'FAQ Q4',title:'What Ringgit assets can be settled using funds from a Non-Resident\'s External Account?',body:'Ringgit Asset includes: (a) Ringgit-denominated securities or Islamic securities issued in Malaysia by a Resident; (b) Ringgit-denominated securities or Islamic securities issued by a Non-Resident as approved by BNM; (c) Ringgit-denominated financial instruments or Islamic financial instruments as approved by BNM; or (d) properties in Malaysia.'},
        {ref:'FAQ Q5',title:'Can a Non-Resident invest in Malaysia via an Institutional Investor?',body:'Yes. There is no restriction on a Non-Resident investing in Malaysia via a Non-Resident Institutional Investor.'},
        {ref:'FAQ Q6',title:'Are there flexibilities given to a Non-Resident Institutional Investor arising from investments in Malaysia?',body:'Yes. A Non-Resident Institutional Investor is accorded flexibilities to manage foreign exchange exposure arising from its investments in Malaysia.'},
      ] },
    ] },
  4: { id:4, short:'N4', icon:'ti-arrows-exchange', title:'Payment and Receipt',
    ...
    secs: [
      ...
      {ref:'Part C, fn. 1 (Para 4)',title:'Miscellaneous expense — meaning',body:'Miscellaneous expense is a Current Account Transaction that is of reasonable amount and infrequent in nature, including but not limited to holiday expenses abroad, medical expenses abroad and advance or reimbursement for purchase of goods and services abroad on behalf of a Resident Individual residing in Malaysia.'},
      {ref:'Part C, fn. 2 (Para 4)',title:'Domestic trade within Global Supply Chain — pass-through payments',body:'This includes pass-through payments for domestic trade in goods or services undertaken via Resident intermediate Entities along the Global Supply Chain.'},
      ...
      {ref:'Part C, fn. 3 (Para 5)',title:'FCY payment to/from Non-Resident — subject to other FEP Notices',body:'Subject to compliance with other FEP Notices.'},
      ...
      {ref:'Part D, Para 7',title:'Remittance business — licensed persons may make/receive payments on behalf of customers',body:'The following persons are allowed to make or receive payment relating to remittance business (as defined in section 2 of the MSBA) for or on behalf of their customers, subject to compliance with the Direction on Dealings with Specified Person and in Restricted Currency: (a) a person licensed under the MSBA to carry out remittance business or its money services business agent; or (b) a person who provides a remittance system approved by the Bank under section 40(1) of the MSBA for a person referred to in (a).'},
      ...
      {ref:'Part F, fn. 4 (Para 9)',title:'External Account — payments require documentary evidence of compliance',body:'Any payment, receipt or transfer from or into an External Account is allowed provided that the Non-Resident is able to produce documentary evidence that the purpose of transaction complies with relevant FEP Notices.'},
      {ref:'Part F, Para 10',title:'NRFI — Ringgit payments for Non-Resident client trade settlement via External Account',body:'Subject to paragraph 12, a NRFI is allowed to undertake the following transactions on behalf of its Non-Resident clients in facilitating settlement of international trade in goods or services between the Non-Resident client and a Resident: (a) make payment in Ringgit to a Resident through the NRFI\'s External Account, provided that any sale of FCY against Ringgit shall be undertaken via straight pass-through transactions matched with a back-to-back arrangement with a LOB; or (b) receive payment in Ringgit from a Resident through the NRFI\'s External Account.'},
      {ref:'Part F, Para 11',title:'Non-Resident Intermediary/NRFI as custodian — Ringgit payments for Ringgit Asset settlement',body:'Subject to paragraphs 12 and 13, a Non-Resident Intermediary or NRFI acting as a custodian or trustee is allowed to make or receive payment in Ringgit to or from a Resident or Non-Resident on behalf of its Resident or Non-Resident clients in facilitating settlement of Ringgit Asset through: (a) a Ringgit account opened and maintained by the Non-Resident Intermediary or NRFI for the Resident client; (b) an External Account of the Non-Resident Intermediary or NRFI; or (c) an External Account opened and maintained by the Non-Resident Intermediary or NRFI for the Non-Resident client.'},
      {ref:'Part F, Para 12',title:'NR Intermediary/NRFI — prohibition on Ringgit financing to clients',body:'Any transaction undertaken under paragraph 10 or 11 shall NOT involve any Ringgit financing by the Non-Resident Intermediary or NRFI to its Resident or Non-Resident clients.'},
      {ref:'Part F, Para 13',title:'NR Intermediary/NRFI as custodian — compliance with Appendix requirements',body:'A Non-Resident Intermediary or NRFI acting as a custodian or trustee managing Ringgit Asset for its clients shall comply with the Appendix to Notice 4 (Requirements on NRFI or Non-Resident Intermediary in Managing Ringgit Asset on Behalf of Clients).'},
      ...
      {ref:'Part F, fn. 5 (Para 14)',title:'Joint FCA — accountholder with Domestic Ringgit Borrowing (DRB)',body:'For a joint FCA where any one accountholder is a Resident Individual with Domestic Ringgit Borrowing (DRB), Part A of Notice 3 shall apply.'},
      {ref:'Part F, Para 15',title:'Resident Individual — transfer of FC funds between FCAs',body:'Subject to Part A of Notice 3, a Resident Individual is allowed to transfer Foreign Currency funds from his FCA into: (a) his own FCA; (b) his joint FCA; or (c) a FCA of his Immediate Family Member, opened individually or jointly with any Individual.'},
      ...
      {ref:'Part F, Para 17',title:'Resident Intermediary — FCA segregation of Resident and Non-Resident client funds',body:'A Resident Intermediary shall segregate Foreign Currency funds belonging to its Resident client from those belonging to its Non-Resident client into a separate FCA opened under the Resident Intermediary\'s name.'},
    ...
    kw:['payment','receipt','pay','receive','ringgit payment','FCY payment','foreign currency payment','repatriate','repatriation','external account','FCA','trade','goods','services','education','employment','migration','immediate family','remittance','global supply chain','open account','maintain account','joint account','joint FCA','DRB','unit trust','fund manager','commodity derivatives','sugar futures','miscellaneous expense','joint venture','FX contract','money changer','futures broker','commodity murabahah'],
    faqs: [
      { subcategory:'Payment in Foreign Currency by Resident', items: [
        {ref:'FAQ Q1',title:'Can a Resident individual pay another Resident in foreign currency (FC)?',body:'A Resident individual is free to pay another Resident in FC for: (a) any purpose between Immediate Family Members (spouse, parents, children and siblings); (b) education, employment or migration outside Malaysia; (c) a transaction between the Resident and a LOB, licensed international takaful operator, or international currency unit of a licensed takaful operator in the conduct of the latter\'s FC business; (d) settlement of FC-denominated derivatives (excluding exchange rate derivatives) on a Specified Exchange under the CMSA between the Resident and a Resident futures broker, subject to prevailing investment in FC asset rules; (e) settlement of commodity murabahah transactions between Residents through a commodity trading service provider; and (f) a miscellaneous expense incurred outside Malaysia between a Resident individual residing in Malaysia and a Resident individual residing outside Malaysia. Approval is required for FC payment between Residents for any other purpose. Note: a "miscellaneous expense" is a current account transaction of reasonable amount and infrequent in nature, including holiday expenses abroad, medical expenses abroad, and advance or reimbursement for goods/services purchased abroad on behalf of a Resident individual residing in Malaysia.'},
        {ref:'FAQ Q2',title:'Can a Resident individual travelling overseas pay FC in advance to a friend (a Resident individual residing outside Malaysia) for holiday expenses, or reimburse the friend in FC after the trip?',body:'Yes. A Resident individual residing in Malaysia may make payment in FC to a Resident individual residing outside Malaysia, provided the payment is for a miscellaneous expense to be incurred (or already incurred) outside Malaysia, of reasonable amount and infrequent in nature.'},
        {ref:'FAQ Q3',title:'Can a Resident individual residing outside Malaysia make payment in FC to a Resident individual residing in Malaysia, where the funds are converted into Ringgit upon receipt?',body:'Yes. Where FC funds remitted by a Resident individual residing outside Malaysia to a Resident individual residing in Malaysia are converted into Ringgit upon receipt, such payment is deemed a payment in Ringgit between Residents, not a FC payment.'},
        {ref:'FAQ Q4',title:'Can a Resident make or receive payment in FC for FC-denominated unit trust funds (or other collective investment schemes) offered by a local licensed fund manager?',body:'Yes. As stipulated in Notice 5, a licensed fund manager is allowed to offer unit trust funds (or other equivalent collective investment schemes) denominated in FC to any person. Payments directly linked to the fund — such as subscription, redemption, sales charge, management fees and performance fees — may be made in the base currency of the fund.'},
        {ref:'FAQ Q5',title:'What type of FC receipts from abroad can a Resident individual keep in their FCA?',body:'A Resident individual may keep FC receipts arising from income, profit, rental, proceeds from divestment of FC assets, and approved FC borrowings in their FCA.'},
        {ref:'FAQ Q6',title:'Two Resident companies have been awarded a joint venture project overseas — can they open a FCA to facilitate payments and receipts under this project?',body:'Yes, provided the FCA is opened by the joint venture entity. However, approval is required for other Resident companies to open and maintain a joint FCA.'},
        {ref:'FAQ Q7',title:'I am a Resident individual who maintains a joint FCA (joint fixed deposit) with a Non-Resident individual — how is the conversion limit for investing in this joint FC fixed deposit applied?',body:'Ringgit conversion for joint investment in foreign currency assets is subject to the annual prudential limit of RM1 million in aggregate PER PERSON per annum, so long as one of the parties is a Resident with DRB. Hence, for this joint FCA, the total conversion limit for the joint FC fixed deposit is RM2 million per annum.'},
        {ref:'FAQ Q8',title:'What is the definition of Global Supply Chain for the purpose of settling domestic trade in FC?',body:'Global Supply Chain is defined as a business activity where a Resident importer purchases goods or services from overseas to support production and distribution of goods or services by a Resident exporter for its export activities. This includes domestic trade transactions between the Resident importer and the Resident exporter undertaken through a Resident intermediate entity.'},
        {ref:'FAQ Q9',title:'Does a Resident exporter need BNM approval to be eligible for the Global Supply Chain FC settlement flexibility?',body:'No. The resident entities operating in the Global Supply Chain shall instead provide any supporting documents requested (e.g. a list of Resident vendors) to the licensed onshore bank facilitating the FC payment, as part of the bank\'s due diligence process.'},
        {ref:'FAQ Q10',title:'Can a Resident exporter convert Ringgit into FC to pay another Resident entity under Global Supply Chain arrangements?',body:'No. The Resident exporter can only source the FC payment from available FC funds in its Trade FCA, or from proceeds of an FC trade financing facility — not from converting Ringgit.'},
        {ref:'FAQ Q11',title:'If a Resident entity has no FC obligations and sells locally-sourced goods to a Resident exporter, can it receive FC from the Resident exporter?',body:'No. Such an arrangement is not deemed a Global Supply Chain activity, so the Resident exporter must pay that Resident entity in Ringgit only.'},
        {ref:'FAQ Q12',title:'Can a Resident providing ancillary services (e.g. shipping and logistics) to another Resident that is directly part of a Global Supply Chain settle those services in FC?',body:'Yes, provided the Resident providing the ancillary services has FC obligations incurred overseas arising from its provision of those services, and the Resident payer has FC proceeds available.'},
        {ref:'FAQ Q13',title:'Can a Resident refuse to receive or pay in FC for domestic trade with another Resident that is part of a Global Supply Chain?',body:'Yes. The FC settlement flexibility for Global Supply Chain trade is on a \'willing buyer, willing seller\' basis — neither the Resident payer nor the Resident receiver can force the other to make or receive payment in FC.'},
        {ref:'FAQ Q14',title:'Can a Resident entity enter into FC-denominated commodity derivatives (e.g. sugar futures) directly with Non-Resident counterparties to hedge commodity price risk?',body:'Yes. A Resident entity may undertake commodity derivatives hedging either via a Resident futures broker, or directly with a Non-Resident counterparty, up to the underlying exposure.'},
        {ref:'FAQ Q15',title:'Can a Resident entity trade non-FX FC derivatives with a Non-Resident counterparty for INVESTMENT purposes (not for price hedging)?',body:'Yes, this is permitted within the investment-abroad limit stipulated under Notice 3 (Investment in Foreign Currency Assets).'},
        {ref:'FAQ Q16',title:'Can a Resident entity enter into an FX contract directly with a Non-Resident counterparty?',body:'No. A Resident entity shall only enter into an FX transaction with a licensed onshore bank or a licensed money changer in Malaysia.'},
      ] },
      { subcategory:'Payment in Ringgit by Non-Resident', items: [
  ...
  5: { id:5, short:'N5', icon:'ti-certificate', title:'Securities and Financial Instruments',
    ...
    secs: [
      ...
      {ref:'Part B, fn. 1 (Para 4)',title:'LOB issuance — subject to scope of business',body:'Depending on its scope of business.'},
      ...
      {ref:'Part B, Para 6',title:'Licensed international Islamic bank — Islamic Financial Instrument in FCY',body:'A licensed international Islamic bank is allowed to issue or offer an Islamic Financial Instrument denominated in Foreign Currency to any person. Where the Islamic Financial Instrument is referenced to exchange rate, the licensed international Islamic bank shall comply with Notice 1.'},
      {ref:'Part B, Para 7',title:'Resident licensed insurer / takaful operator — insurance or takaful product linked to Financial Instrument',body:'A Resident licensed insurer or takaful operator is allowed to issue or offer an insurance product or a takaful product linked to a Financial Instrument denominated in Ringgit to a Non-Resident. Note: any insurance or takaful product NOT linked to a Financial Instrument shall be regarded as a SERVICE for the purposes of the FEP Notices.'},
      {ref:'Part B, fn. 2 (Para 7)',title:'Insurance or takaful product not linked to a Financial Instrument — treated as a service',body:'Any insurance or takaful product not linked to a Financial Instrument shall be regarded as a service for purposes of FEP Notices.'},
    ...
    kw:['security','securities','financial instrument','bond','sukuk','share','equity','issue','issuance','derivative','interest rate derivative','Bursa Malaysia','LOB','exchange rate derivative','subscription','transfer','corporate bond','redeemable preference shares','RPS','Islamic bank','Islamic financial instrument','insurance','takaful','insurance product','takaful product'] },
  6: { id:6, short:'N6', icon:'ti-plane-departure', title:'Import and Export of Currency',
    ...
    secs: [
      ...
      {ref:'Para 1(2)',title:'Gazette Notice — copy reproduced in Appendix',body:'A copy of the Gazette Notice [G.N. 38691/2013] is reproduced in the Appendix to Notice 6.'},
      {ref:'G.N. 38691/2013 — Ringgit (Import)',title:'Traveller importing Ringgit into Malaysia',body:'A traveller entering Malaysia is allowed to bring in Ringgit currency notes. Import of Ringgit above RM10,000 must be declared to customs upon arrival. Amounts above the declarable threshold brought in without declaration are not permitted.'},
      {ref:'G.N. 38691/2013 — Ringgit (Export)',title:'Traveller exporting Ringgit out of Malaysia',body:'A traveller leaving Malaysia is allowed to bring out Ringgit currency notes up to RM1,000 per trip only. Export of Ringgit ABOVE RM1,000 is NOT PERMITTED under any circumstances.'},
      {ref:'G.N. 38691/2013 — Foreign Currency',title:'Traveller importing or exporting Foreign Currency',body:'A traveller may bring in or take out Foreign Currency notes. Amounts exceeding RM30,000 equivalent in Foreign Currency must be declared to the Royal Malaysian Customs Department. There is no upper limit on FCY import/export but declaration is mandatory above RM30,000 equivalent. Failure to declare is a violation.'},
      {ref:'G.N. 38691/2013 — Non-Traveller',title:'Non-traveller import/export of currency',body:'Entities (e.g. courier, postal services) importing or exporting currency must comply with Gazette Notice conditions or obtain specific FEP Authority approval. Bulk cash movements by financial institutions follow separate LOB guidelines.'},
    ],
  ...
  7: { id:7, short:'N7', icon:'ti-ship', title:'Export of Goods',
    ...
    secs: [
      ...
      {ref:'Part A, Para 1(b)',title:'Resident exporter — receipt in FULL VALUE (approved deductions allowed)',body:'Export proceeds must be received in FULL VALUE excluding: (i) approved deductions related to the Export of Goods as listed in Appendix A; and (ii) amount spent for approved offsetting or writing-off arrangements as listed in Appendix B.'},
      {ref:'Appendix A',title:'Approved Deductions — full list',body:'Approved deductions refer to any one or more of the following: (a) agency commission including advertising or promotion expenses; (b) handling charge including freight and insurance or takaful costs; (c) administrative error; (d) discount by the Resident exporter; (e) quality and/or quantity claim; (f) short-shipment; (g) shut-out; (h) write-off arising from fraud; (i) goods that the Resident exporter does not own but is receiving payment for value added input; or (j) buyer is under liquidation.'},
      {ref:'Part A, Para 1(c)',title:'Export proceeds timeline — 6 months standard; 24 months for approved circumstances (Appendix C)',body:'Export proceeds must be received earlier than or in accordance with the payment date of the export contract, NOT EXCEEDING SIX (6) MONTHS from date of shipment. EXCEPTION: where any of the circumstances in Appendix C applies, the Resident exporter may receive proceeds up to TWENTY-FOUR (24) MONTHS from date of shipment.'},
      {ref:'Appendix C',title:'Approved Circumstances — receipt of export proceeds up to 24 months from shipment',body:'Proceeds may be received up to 24 months from date of shipment where: (1) The Resident exporter has no control over the delay due to unexpected circumstances, including: (a) buyer in financial difficulties; (b) buyer cancels, delays, disputes or does not respond to request for payment; (c) restriction on foreign exchange transactions in the buyer\'s country; (d) quality and/or quantity claims; or (e) incidence of fraud. (2) The Resident exporter has exported goods on credit terms of up to 24 months for: (a) consignment sale; or (b) goods that involve testing and commissioning.'},
      {ref:'Part A, Para 2',title:'Exemption — export proceeds receipt obligation does NOT apply to goods in Appendix D',body:'Paragraph 1 (the receipt obligation) shall NOT apply to proceeds of Export of Goods categorised under Appendix D.'},
      {ref:'Appendix D',title:'Non-Receipt of Export Proceeds — approved cases',body:'Non-receipt of export proceeds is allowed for goods exported: (a) under a border trade agreement entered into by the Government of Malaysia with any foreign government; or (b) where the goods are not for sale — (i) gift, donation, personal effects or business sample; (ii) goods exported for further processing, testing, repairing, exchange or exhibition, and subsequently will be imported back to Malaysia; or (iii) goods belonging to a Non-Resident that are exported after an exhibition in Malaysia or upon expiry of a lease or rental.'},
      {ref:'Part B, Para 3',title:'Non-Resident — permissible sources for Ringgit payment of export proceeds',body:'Where a Non-Resident undertakes settlement for an Export of Goods in Ringgit in Malaysia, the Ringgit shall be sourced from: (a) buying of Ringgit against Foreign Currency in accordance with Part B of Notice 1; (b) an External Account of the Non-Resident; (c) an External Account of an NRFI acting on behalf of the Non-Resident — WHERE IT SHALL INVOLVE the buying of Ringgit in accordance with Part B of Notice 1; or (d) a Ringgit trade financing facility from a LOB in accordance with Part D of Notice 2.'},
    ...
    faqs: [
      { subcategory:'Export of Goods', items: [
...
function faqCiteRef(sub, ref) { return `${sub} — ${ref}`; }
function faqTotal(n) { return (n.faqs||[]).reduce((a,g) => a + g.items.length, 0); }
...
Object.values(NOTICES).forEach(n => {
  ...
  (n.faqs||[]).forEach(g => g.items.forEach(s => CHUNKS.push({ noticeId:n.id, noticeName:n.short, noticeTitle:n.title, sub:g.subcategory, ref:faqCiteRef(g.subcategory, s.ref), title:s.title, body:s.body })));
});
...
const GLOSSARY = {
  ...
  'DRB': 'Domestic Ringgit Borrowing — any Ringgit borrowing obtained by a Resident from another Resident, excluding one (1) housing loan, one (1) vehicle loan, and sundry/employee facilities. A Resident with only one (1) housing loan and/or one (1) vehicle loan (and no other Ringgit borrowing from another Resident) does NOT have DRB — this includes a Resident who has BOTH exactly one (1) housing loan AND exactly one (1) vehicle loan AT THE SAME TIME (one of each is still within the excluded combination, not "more than one" of either type). IMPORTANT: having MORE THAN one (1) housing loan, OR more than one (1) vehicle loan (each loan type counted separately), means the Resident is deemed to HAVE DRB (loses the unlimited-investment exemption and becomes subject to the RM1 million / RM50 million annual limits under Notice 3).',
  'Joint Account': 'Per Notice 4, footnote 5 to Para 14: for a joint FCA where any one accountholder is a Resident Individual with Domestic Ringgit Borrowing (DRB), Part A of Notice 3 shall apply. Per the Resident Payment in FC FAQ: Ringgit conversion for joint investment in foreign currency assets is subject to the annual prudential limit of RM1 million in aggregate per person per annum, so long as one of the parties is a Resident with DRB — hence for this joint FCA, the total conversion limit for the joint FC fixed deposit would be RM2 million per annum (for 2 joint accountholders). IMPORTANT: if NEITHER joint accountholder has DRB, this RM1 million-per-person / RM2 million-combined limit does NOT apply at all — Notice 3 Part A Para 1 (UNLIMITED) governs the joint investment instead.',
  ...
  'Direct Shareholder': 'A shareholder (Resident or Non-Resident, individual or entity) holding at least 10% effective shareholding in a Resident Entity. Under Notice 2 (Part B, Para 9), a Resident Entity is permitted to borrow Foreign Currency in ANY amount from its Direct Shareholder — e.g. a Direct Shareholder settling the Entity\'s FCY obligation (such as an import payment) directly with a Non-Resident counterparty is treated as a permitted, unlimited FCY loan from the Direct Shareholder to the Entity.',
...
7. DRB check (apply literally, do not assume): a Resident Individual/Entity has Domestic Ringgit Borrowing (DRB) ONLY if they have (a) MORE THAN one (1) housing loan, OR (b) MORE THAN one (1) vehicle loan, OR (c) any other Ringgit borrowing from another Resident not in the excluded categories (see DRB definition). Count housing loans and vehicle loans SEPARATELY by type — holding exactly ONE (1) housing loan and exactly ONE (1) vehicle loan AT THE SAME TIME is only ONE of each type, NOT "more than one" of either type, so it does NOT give a Resident DRB. Only TWO OR MORE housing loans, or TWO OR MORE vehicle loans (each type counted on its own), trigger DRB under (a)/(b). With no other such Ringgit borrowing, that Resident remains in the "WITHOUT DRB" / unlimited-investment category under Notice 3.
   WORKED EXAMPLE: Person A has no Ringgit borrowing at all -> WITHOUT DRB -> UNLIMITED investment in FC asset (Notice 3 Part A Para 1). Person B has exactly ONE (1) outstanding housing loan and no other Ringgit borrowing from a Resident -> still WITHOUT DRB (one housing loan is excluded from the DRB definition) -> ALSO UNLIMITED investment under Notice 3 Part A Para 1 — do NOT apply the RM1 million limit (Para 2) to Person B, since Para 2 only applies to a Resident Individual WITH DRB. Person C has exactly ONE (1) outstanding housing loan AND exactly ONE (1) outstanding vehicle loan AT THE SAME TIME (one of each, not two of either type), and no other Ringgit borrowing from a Resident -> still WITHOUT DRB (one housing loan + one vehicle loan together is exactly the excluded combination in the DRB definition, NOT "more than one" of either type) -> ALSO UNLIMITED under Notice 3 Part A Para 1. Do NOT add a housing loan and a vehicle loan together and call the sum "more than one loan" — DRB requires more than one of the SAME loan type.
8. Notice 3 Part A Para 1 (UNLIMITED, applies ONLY to a Resident WITHOUT DRB) and Part A Para 2 (RM1 million/year cap, applies ONLY to a Resident WITH DRB) are MUTUALLY EXCLUSIVE — never merge them into one statement. If EVERY party to the transaction is WITHOUT DRB, the verdict is governed ENTIRELY by Para 1: state their investment is allowed up to ANY amount, do NOT mention any RM amount or limit (RM1 million, RM2 million, etc.) anywhere in the explanation, and do NOT perform or reference any RM-limit comparison for that party. Only a party WITH DRB is subject to Para 2's RM1 million/year cap.
9. JOINT TRANSACTIONS (Notice 4 FAQ Q12): if two or more Resident individuals are jointly remitting/investing (e.g. from a joint RM account), first determine EACH party's DRB status individually using rule 7.
   - If NONE of the joint parties has DRB, the joint investment is governed ENTIRELY by Part A Para 1 (UNLIMITED) per rule 8 above — do NOT mention, apply, or compare against any RM1 million or RM2 million limit, and do NOT cite Notice 4 FAQ Q12.
   - If AT LEAST ONE joint party has DRB, the joint investment is subject to the RM1 million PER PERSON annual limit under Notice 4 FAQ Q12 — for 2 joint parties this is a COMBINED threshold of RM2 million (NOT RM1 million). Compare the TOTAL joint remittance/investment amount against this COMBINED threshold, and cite Notice 4 FAQ Q12 alongside Notice 3 Part A Para 2. Do NOT reason that the joint investment is "unlimited" merely because one of the OTHER joint parties has no DRB — DRB in ANY single joint party caps the WHOLE joint investment at RM2 million (for 2 parties); it does NOT make it unlimited.
10. ARITHMETIC CHECK: whenever you compare a converted RM amount against a numeric threshold (e.g. RM1 million, or RM2 million for a joint transaction under rule 9), explicitly verify the comparison before writing your conclusion: if the converted amount is GREATER than the threshold, the correct word is "EXCEEDS" (not "is within" / "does not exceed"); if it is less than or equal to the threshold, the correct word is "does not exceed" / "is within". Re-check the two numbers digit-by-digit before choosing which word to use — do not state a conclusion that contradicts the numbers you just computed.
