...
const NOTICES = {
  ...
  3: { id:3, short:'N3', icon:'ti-chart-line', title:'Investment in Foreign Currency Asset',
    ...
    faqs: [
      ...
      {ref:'FAQ Q30',title:'How is the RM1 million investment limit applied when the investment is funded from a Foreign Currency Account (FCA) held jointly by Resident individuals?',body:'Per Notice 4 (Part F, Para 15), if ANY ONE accountholder of a jointly-held FCA is a Resident Individual with DRB, Part A of Notice 3 applies to the joint FCA as a whole. The joint FCA is then treated as belonging to a Resident Individual WITH DRB (Notice 3 Part A, Para 2) and is subject to a SINGLE RM1 million annual aggregate limit for the joint FCA — not RM1 million per accountholder — even if the other joint accountholder(s) individually have no DRB.'},
    ] },
  4: { id:4, short:'N4', icon:'ti-arrows-exchange', title:'Payment and Receipt',
    ...
    secs: [
      ...
      {ref:'Part F, Para 15',title:'Joint FCA — accountholder with Domestic Ringgit Borrowing (DRB)',body:'For a Foreign Currency Account (FCA) held jointly by Resident Individuals, where ANY ONE accountholder is a Resident Individual with Domestic Ringgit Borrowing (DRB), Part A of Notice 3 shall apply to the joint FCA — i.e. the joint FCA is treated as belonging to a Resident Individual WITH DRB and is subject to the RM1 million annual aggregate investment-in-FC-asset limit under Notice 3 Part A, Para 2, even if the other joint accountholder(s) individually have no DRB.'},
    ...
    kw:['payment','receipt','pay','receive','ringgit payment','FCY payment','foreign currency payment','repatriate','repatriation','external account','FCA','trade','goods','services','education','employment','migration','immediate family','remittance','global supply chain','open account','maintain account','joint account','joint FCA','DRB'],
    faqs: [
...
const GLOSSARY = {
  ...
  'Joint Account': 'Per Notice 4 (Part F, Para 15), for a Foreign Currency Account (FCA) held jointly by Resident Individuals, if ANY ONE accountholder is a Resident Individual with DRB, Part A of Notice 3 applies to the joint FCA as a WHOLE — i.e. the joint FCA is treated as belonging to a Resident Individual WITH DRB (Notice 3 Part A, Para 2), subject to a SINGLE RM1 million annual aggregate investment-in-FC-asset limit for the joint FCA, even if the other joint accountholder(s) individually have no DRB. This is NOT doubled or split per accountholder.',
