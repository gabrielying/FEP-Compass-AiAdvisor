...
const NOTICES = {
  ...
  2: { id:2, short:'N2', icon:'ti-building-bank', title:'Borrowing, Lending and Guarantee',
    ...
    faqs: [
      ...
      {ref:'FAQ Q40',title:'Can a Resident guarantor instruct the liquidation of a FG to voluntarily repay the borrowing on behalf of the borrower?',body:'No — a guarantor may not initiate a "call-upon" of a FG. If a guarantor intends to voluntarily liquidate a FG to support the borrower, the guarantor must obtain prior approval from BNM in accordance with Notice 3 (the liquidation is treated as an investment in FC asset).'},
  ...
  3: { id:3, short:'N3', icon:'ti-chart-line', title:'Investment in Foreign Currency Asset',
    ...
    faqs: [
      ...
      {ref:'FAQ Q30',title:'How is the RM1 million investment limit applied when the investment is funded from a Foreign Currency Account (FCA) held jointly by Resident individuals?',body:'If ANY ONE accountholder of a jointly-held FCA is a Resident Individual with DRB, Part A of Notice 3 applies to the joint FCA (Notice 4, Part F, fn. 5 to Para 14) — i.e. the joint FCA is treated as belonging to a Resident Individual WITH DRB (Notice 3 Part A, Para 2) rather than being free of the investment-in-FC-asset limit, even if the other joint accountholder(s) individually have no DRB. The RM1 million annual aggregate conversion limit under Notice 3 Part A, Para 2(c) is computed PER PERSON per annum — so for a joint FCA with 2 accountholders, the COMBINED conversion limit for the joint FCA is RM2 million per annum (RM1 million per accountholder), as long as one of the accountholders has DRB.'},
    ] },
  4: { id:4, short:'N4', icon:'ti-arrows-exchange', title:'Payment and Receipt',
    ...
    secs: [
      ...
      {ref:'Part F, fn. 5 (Para 14)',title:'Joint FCA — accountholder with Domestic Ringgit Borrowing (DRB)',body:'For a Foreign Currency Account (FCA) held jointly by Resident Individuals, where ANY ONE accountholder is a Resident Individual with Domestic Ringgit Borrowing (DRB), Part A of Notice 3 shall apply to the joint FCA — i.e. the joint FCA is treated as belonging to a Resident Individual WITH DRB (Notice 3 Part A, Para 2) rather than being free of the investment-in-FC-asset limit, even if the other joint accountholder(s) individually have no DRB. Per the Resident Payment in FC FAQ, the RM1 million annual aggregate conversion limit under Notice 3 Part A, Para 2(c) is computed PER PERSON per annum — so for a joint FCA with 2 accountholders, the combined conversion limit for the joint FCA is RM2 million per annum (RM1 million per accountholder).'},
    ...
    faqs: [
      ...
      {ref:'FAQ Q11',title:'Two Resident companies have been awarded a joint venture project overseas — can they open a FCA to facilitate payments and receipts under this project?',body:'Yes, provided the FCA is opened by the joint venture entity itself. Approval is required, however, for two or more separate Resident companies to jointly open and maintain a JOINT FCA in their own names for this purpose.'},
      ...
      {ref:'FAQ Q13',title:'What is the definition of Global Supply Chain for the purpose of settling domestic trade in FC?',body:'Global Supply Chain is a business activity where a Resident importer purchases goods or services from overseas to support production and distribution of goods or services by a Resident exporter for its export activities. This includes domestic trade transactions between the Resident importer and the Resident exporter undertaken through a resident intermediate entity. Within this chain: the Resident exporter may receive export proceeds in FC, the Resident importer may make import payments in FC, and FC payments are allowed to/from Resident vendor(s) in the chain.'},
...
const GLOSSARY = {
  ...
  'Joint Account': 'Per Notice 4 (Part F, fn. 5 to Para 14), for a Foreign Currency Account (FCA) held jointly by Resident Individuals, if ANY ONE accountholder is a Resident Individual with DRB, Part A of Notice 3 applies to the joint FCA — i.e. the joint FCA is treated as belonging to a Resident Individual WITH DRB (Notice 3 Part A, Para 2) rather than being free of the investment-in-FC-asset limit, even if the other joint accountholder(s) individually have no DRB. Per the Resident Payment in FC FAQ, the RM1 million annual aggregate conversion limit under Notice 3 Part A, Para 2(c) is computed PER PERSON per annum — so for a joint FCA with 2 accountholders, the COMBINED conversion limit for the joint FCA is RM2 million per annum (RM1 million per accountholder).',
