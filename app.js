...
const NOTICES = {
  ...
  6: { id:6, short:'N6', icon:'ti-plane-departure', title:'Import and Export of Currency',
    desc:'Carrying cash across the Malaysian border — the RM1,000 Ringgit limit for travellers, and the separate USD10,000-equivalent Customs declaration for cash and bearer negotiable instruments.',
    secs: [
      {ref:'FEP Notice 6',title:'Two separate cross-border cash regimes',body:'Carrying currency across the Malaysian border is governed by two separate regimes: (1) a Ringgit exchange-control limit administered by the FEP Authority (BNM\'s Balance of Payments Department) under FEP Notice 6; and (2) a Cash and Bearer Negotiable Instrument (CBNI) declaration requirement to the Royal Malaysian Customs Department under the Anti-Money Laundering, Anti-Terrorism Financing and Proceeds of Unlawful Activities Act 2001 (AMLATFPUAA), which applies to Ringgit and Foreign Currency alike.'},
      {ref:'FEP Notice 6',title:'Traveller — Ringgit currency notes (import AND export)',body:'A traveller (Resident or Non-Resident) entering or leaving Malaysia is allowed to carry Ringgit currency notes up to RM1,000 only, per traveller per trip — this limit applies in BOTH directions, not just on export. Carrying Ringgit notes above RM1,000 requires prior written approval from the Head, Balance of Payments Department, Bank Negara Malaysia, obtained before travel; it is not an outright prohibition, but is not permitted without that approval.'},
      {ref:'AMLATFPUAA — CBNI declaration',title:'Traveller — Cash and Bearer Negotiable Instruments (any currency)',body:'There is no upper limit on the amount of Foreign Currency notes or traveller\'s cheques a traveller may bring into or take out of Malaysia. However, cash and bearer negotiable instruments (in Ringgit, Foreign Currency, or both combined) equivalent to USD10,000 or more must be declared to the Royal Malaysian Customs Department (Customs Form No. 7 / K7) upon entry or exit, regardless of direction. Failure to declare is an offence under the AMLATFPUAA, punishable by a fine of up to RM3 million and/or imprisonment of up to 5 years.'},
      {ref:'Gazette Notice',title:'Non-traveller import/export of currency',body:'Entities (e.g. courier, postal services, cash-in-transit operators) importing or exporting currency on behalf of others must comply with the same CBNI declaration requirements, or obtain specific approval from the FEP Authority. Bulk cash movements by financial institutions follow separate LOB / BNM guidelines.'},
    ],
    kw:['import','export','traveller','cash','currency notes','ringgit','carry','bring','border','customs','RM1,000','USD10,000','CBNI','bearer negotiable instrument','declaration','declare','Balance of Payments Department','AMLATFPUAA','physical currency','notes','coins','bulk cash','smuggle'] },
...
/* ━━━ GLOSSARY ━━━ */
const GLOSSARY = {
  'Resident': 'A Malaysian citizen (excluding citizens with permanent residence abroad who reside abroad), a non-citizen who has obtained permanent resident status in Malaysia and is ordinarily residing in Malaysia, a body incorporated in Malaysia, or the Malaysian Government.',
...
const QUICKCHECK = {
  ...
  6: { start:'a', nodes:{
      ...
      b:{ q:'Does the Ringgit being carried exceed RM1,000 (in either direction)?', yes:{ type:'warn', t:'Affected — RM1,000 Ringgit cap (both directions)', d:'A traveller, Resident or Non-Resident, may carry at most RM1,000 in Ringgit notes per trip — entering OR leaving Malaysia. Amounts above RM1,000 require prior written approval from BNM\'s Balance of Payments Department before travel; it is not an outright ban.' }, no:'c' },
      c:{ q:'Does the total cash and bearer negotiable instruments carried (any currency, incl. Ringgit and FCY) equal or exceed USD10,000 equivalent?', yes:{ type:'info', t:'Affected — Customs CBNI declaration', d:'Amounts equivalent to USD10,000 or more must be declared to the Royal Malaysian Customs Department (Form No. 7/K7) under the AMLATFPUAA, regardless of currency or direction. Failure to declare is an offence (fine up to RM3 million and/or up to 5 years\' imprisonment).' }, no:{ type:'ok', t:'Likely not affected', d:'Cash within the RM1,000 Ringgit limit and below the USD10,000-equivalent CBNI declaration threshold can generally be carried freely.' } },
  }},
  7: { start:'a', nodes:{
