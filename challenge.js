...
const CHALLENGE_BANK = [
  ...
  /* ── Training-quiz set: reworded from internal quiz material (names, banks,
        amounts and months changed; answers re-derived from the kb.js provisions) ── */
  {
    id: 'mcq-user-01', notice: 3, type: 'mcq',
    q: 'A Resident Individual WITH Domestic Ringgit Borrowing converts Ringgit to buy a RM4 million apartment abroad as accommodation for her daughter. Under Notice 3, the "any amount" real-estate carve-out applies when the property is for the Resident\'s own or Immediate Family Member\'s accommodation for which purposes?',
    opts: ['Education only', 'Education and employment only', 'Employment and migration only', 'Education, employment or migration outside Malaysia'],
    answer: 3,
    ref: 'Part A, Para 2',
    rationale: 'Notice 3 Part A, Para 2(b): a Resident Individual with DRB may invest ANY amount in real estate outside Malaysia for education, employment or migration — for the Resident\'s own or Immediate Family Member\'s accommodation only. Outside those purposes, a conversion-funded purchase falls under the Para 2(c) RM1 million annual cap instead.',
  },
  {
    id: 'mcq-user-02', notice: 3, type: 'mcq',
    q: 'A Resident Individual holds two housing loans with two different local banks. This calendar year she has already converted RM250,000 (March) and RM350,000 (August) into foreign currency investments. How much more may she invest via conversion of Ringgit this year (e.g. into a dual currency investment)?',
    opts: ['Any amount', 'RM400,000 equivalent', 'RM600,000 equivalent', 'RM1 million equivalent'],
    answer: 1,
    ref: 'Part A, Para 2',
    rationale: 'Two housing loans is MORE than one of the same loan type, so she has Domestic Ringgit Borrowing. Notice 3 Part A, Para 2(c) caps conversion-of-Ringgit investment at RM1 million equivalent per calendar year in aggregate: RM1,000,000 − (RM250,000 + RM350,000) = RM400,000 remaining.',
  },
  {
    id: 'mcq-user-03', notice: 3, type: 'mcq',
    q: 'Encik Rahman is a Resident sole-proprietor. His sole-proprietorship business has Domestic Ringgit Borrowing, but he has no borrowing personally. Does the business\'s DRB status affect his investment limit when he invests under his own name?',
    opts: ['Yes', 'No'],
    answer: 0,
    ref: 'Part A, Para 2',
    rationale: 'Notice 3 Part A, Para 2: the RM1 million per calendar year conversion cap is computed IN AGGREGATE including any sole proprietorship or General Partnership owned by the same individual — so the sole-proprietorship\'s DRB carries over to his personal investments.',
  },
  {
    id: 'mcq-user-04', notice: 4, type: 'mcq',
    q: 'A Resident Individual with no Domestic Ringgit Borrowing invests in foreign currency assets from a joint savings account held with his Resident brother, who HAS DRB. What is the total annual limit for Ringgit conversion under the joint account?',
    opts: ['RM1 million (shared between both)', 'RM2 million (RM1 million per person per annum)', 'RM500,000', 'Any amount'],
    answer: 1,
    ref: 'Payment in Foreign Currency by Resident — FAQ Q7',
    rationale: 'Notice 4 "Payment in Foreign Currency by Resident" FAQ Q7: Ringgit conversion for a joint investment is subject to the RM1 million in aggregate PER PERSON per annum prudential limit so long as one joint party is a Resident with DRB — RM2 million per annum in total for two persons.',
  },
  {
    id: 'mcq-user-05', notice: 3, type: 'mcq',
    q: 'When does a local bank typically require a Resident investor to complete its DRB / investment declaration form for investing in foreign currency assets using funds sourced from conversion of Ringgit or a Trade FCA?',
    opts: ['For each and every such FCY-asset investment transaction, onshore and abroad', 'Once a year', 'Every half year', 'Only when the investor\'s DRB status changes'],
    answer: 0,
    ref: 'Part A, Para 2',
    rationale: 'Each bank issues its own declaration form as operational practice (the form itself is not prescribed in the Notice text). It is obtained per transaction so the bank can monitor the investor\'s current DRB status against Notice 3 Part A, Para 2(c)\'s RM1 million equivalent per calendar year conversion cap, which is an aggregate annual limit.',
  },
  {
    id: 'mcq-user-06', notice: 7, type: 'mcq',
    q: 'A Resident manufacturer ships goods to a buyer in Vietnam. Under Notice 7, by when must the export proceeds be received (absent any approved circumstances)?',
    opts: ['No deadline applies', 'Within 6 months from the date of shipment', 'Within 18 months from the invoice date', 'Within 24 months from the invoice date'],
    answer: 1,
    ref: 'Part A, Para 1(c)',
    rationale: 'Notice 7 Part A, Para 1(c): export proceeds must be received earlier than or in accordance with the payment date of the export contract, not exceeding SIX (6) months from the date of shipment — the clock runs from shipment, not the invoice date.',
  },
  {
    id: 'mcq-user-07', notice: 7, type: 'mcq',
    q: 'Which proceeds does Notice 7\'s repatriation requirement actually apply to?',
    opts: ['Export of goods, export of services and merchanting trade', 'Export of goods only — not export of services or merchanting trade', 'Export of services only', 'Merchanting trade only'],
    answer: 1,
    ref: 'Export of Goods — FAQ Q3',
    rationale: 'Notice 7 FAQ Q3: the repatriation requirement applies to export of goods only. It does not apply to foreign currency proceeds from export of services or merchanting trade (goods shipped between two overseas locations without entering or leaving Malaysia).',
  },
  {
    id: 'mcq-user-08', notice: 7, type: 'mcq',
    q: 'Under Notice 7 Appendix C, which of these circumstances allow a Resident exporter to receive export proceeds up to 24 months from the date of shipment? I. Buyer in financial difficulties. II. Incidence of fraud. III. Quality or quantity claims. IV. Foreign exchange restrictions in the buyer\'s country.',
    opts: ['I and II only', 'I, II and III only', 'II, III and IV only', 'All of I, II, III and IV'],
    answer: 3,
    ref: 'Appendix C',
    rationale: 'Notice 7 Appendix C(1): proceeds may be received up to 24 months from shipment where the exporter has no control over the delay, including buyer in financial difficulties; buyer cancels, delays or disputes payment; FX restrictions in the buyer\'s country; quality and/or quantity claims; or incidence of fraud.',
  },
  {
    id: 'mcq-user-09', notice: 7, type: 'mcq',
    q: 'Notice 7\'s export-of-goods requirements apply to which Residents? I. Individuals. II. Sole proprietorships. III. General partnerships. IV. Entities.',
    opts: ['IV only', 'II, III and IV only', 'I, II and III only', 'All of I, II, III and IV'],
    answer: 3,
    ref: 'Export of Goods — FAQ Q7',
    rationale: 'Notice 7 FAQ Q7: the export of goods requirements apply to ALL Residents — including individuals, sole proprietorships and general partnerships — with one carve-out: export of goods by a Resident individual for personal consumption.',
  },
  {
    id: 'mcq-user-10', notice: 7, type: 'mcq',
    q: 'A Resident exporter receives its export proceeds in several instalments. Which of the following are consistent with Notice 7? I. Final payment received within 6 months of shipment. II. Final payment received within 24 months where an Appendix C circumstance applies. III. Final payment received later than that, with prior written approval obtained from the FEP Authority.',
    opts: ['I only', 'I and II only', 'II and III only', 'All of I, II and III'],
    answer: 3,
    ref: 'Part A, Para 1(c)',
    rationale: 'Notice 7 Part A, Para 1(c): receipt must not exceed 6 months from shipment, except that an Appendix C circumstance allows up to 24 months. Per FAQ Q8, delays outside a permitted reason require FEP Authority approval, applied for before the receipt period expires.',
  },
  /* ── Flipped counterparts of the set above — the key fact is inverted ── */
  {
    id: 'mcq-user-11', notice: 3, type: 'mcq',
    q: 'A Resident Individual WITH Domestic Ringgit Borrowing converts Ringgit to buy an apartment abroad purely as a RENTAL investment — not accommodation for herself or an Immediate Family Member. Does the "any amount" real-estate carve-out apply?',
    opts: ['Yes — all real estate abroad qualifies for any amount', 'No — the conversion counts against her RM1 million per calendar year cap'],
    answer: 1,
    ref: 'Part A, Para 2',
    rationale: 'Notice 3 Part A, Para 2(b)\'s any-amount treatment covers real estate for education, employment or migration, as own/Immediate Family accommodation ONLY. A rental/investment property doesn\'t qualify, so the conversion-funded purchase falls under Para 2(c)\'s RM1 million equivalent annual cap.',
  },
  {
    id: 'mcq-user-12', notice: 3, type: 'mcq',
    q: 'A Resident Individual has exactly ONE housing loan and no other Ringgit borrowing from Residents. How much may he invest in foreign currency assets using conversion of Ringgit?',
    opts: ['RM1 million equivalent per calendar year', 'RM2 million equivalent per calendar year', 'Any amount — a single housing loan alone does not create DRB', 'Nothing without FEP Authority approval'],
    answer: 2,
    ref: 'Part A, Para 1',
    rationale: 'One housing loan is not "more than one" of the same loan type, so he has NO Domestic Ringgit Borrowing. Notice 3 Part A, Para 1: a Resident Individual without DRB may invest in Foreign Currency Asset up to ANY amount, onshore and offshore.',
  },
  {
    id: 'mcq-user-13', notice: 3, type: 'mcq',
    q: 'Puan Aisyah personally has Domestic Ringgit Borrowing. Her sole-proprietorship business, which has no borrowing of its own, wants to invest in foreign currency assets using converted Ringgit. Is the business\'s investment capped by her personal DRB status?',
    opts: ['Yes — the RM1 million annual cap is computed in aggregate across her and her sole proprietorship', 'No — the business is assessed entirely on its own'],
    answer: 0,
    ref: 'Part A, Para 2',
    rationale: 'Notice 3 Part A, Para 2: the RM1 million per calendar year conversion cap is computed in aggregate including any sole proprietorship or General Partnership owned by the same individual — the aggregation works in both directions.',
  },
  {
    id: 'mcq-user-14', notice: 4, type: 'mcq',
    q: 'Two Resident spouses invest in foreign currency assets from their joint savings account, and NEITHER of them has Domestic Ringgit Borrowing. What is the limit on their joint investment from conversion of Ringgit?',
    opts: ['RM1 million per annum', 'RM2 million per annum', 'Any amount — the per-person prudential limit only engages when a joint party has DRB', 'RM500,000 per annum'],
    answer: 2,
    ref: 'Payment in Foreign Currency by Resident — FAQ Q7',
    rationale: 'Notice 4 FAQ Q7 applies the RM1 million per person per annum limit "so long as one of the parties is a Resident with DRB". With no DRB on either side, the joint investment is instead governed by Notice 3 Part A, Para 1 — up to any amount.',
  },
  {
    id: 'mcq-user-15', notice: 3, type: 'mcq',
    q: 'A Resident Individual WITH Domestic Ringgit Borrowing maintains accounts with three different Licensed Onshore Banks. Does she get a fresh RM1 million conversion allowance at each bank?',
    opts: ['Yes — the cap applies per bank', 'No — RM1 million equivalent per calendar year in aggregate, across all banks'],
    answer: 1,
    ref: 'Part A, Para 2',
    rationale: 'Notice 3 Part A, Para 2(c) is an aggregate annual cap on the investor, not a per-institution allowance — which is exactly why banks collect DRB/investment declarations, to monitor conversions made across the year.',
  },
  {
    id: 'mcq-user-16', notice: 7, type: 'mcq',
    q: 'A Resident exporter receives the full export proceeds exactly 6 months from the date of shipment, with no Appendix C circumstance involved. Is it compliant without any FEP Authority approval?',
    opts: ['Yes — receipt not exceeding 6 months from shipment is within the rule', 'No — using the full 6 months requires FEP Authority approval'],
    answer: 0,
    ref: 'Part A, Para 1(c)',
    rationale: 'Notice 7 Part A, Para 1(c) requires receipt NOT EXCEEDING six (6) months from the date of shipment — exactly at 6 months is at the limit, not beyond it, so no approval is needed.',
  },
  {
    id: 'mcq-user-17', notice: 7, type: 'mcq',
    q: 'A Resident IT company earns foreign currency from exporting SERVICES to overseas clients. Must those proceeds be repatriated to Malaysia under Notice 7?',
    opts: ['Yes — all export earnings must be repatriated within 6 months', 'No — the repatriation requirement covers export of goods only'],
    answer: 1,
    ref: 'Export of Goods — FAQ Q3',
    rationale: 'Notice 7 FAQ Q3: the repatriation requirement applies to export of goods only — it does not apply to foreign currency proceeds from export of services or merchanting trade.',
  },
  {
    id: 'mcq-user-18', notice: 7, type: 'mcq',
    q: 'A Non-Resident buyer simply prefers to settle in 20 months; none of the Appendix C circumstances applies. May the Resident exporter accept receipt beyond 6 months from shipment without FEP Authority approval?',
    opts: ['Yes — anything within 24 months is automatically acceptable', 'No — beyond 6 months without an Appendix C circumstance requires FEP Authority approval'],
    answer: 1,
    ref: 'Appendix C',
    rationale: 'Notice 7 Appendix C\'s 24-month flexibility covers delays outside the exporter\'s control (buyer in financial difficulties, disputes, FX restrictions, quality/quantity claims, fraud) or credit terms for consignment sales / testing and commissioning. A buyer\'s mere preference is none of these, so Part A, Para 1(c)\'s 6-month rule stands and approval is required to go beyond it.',
  },
  {
    id: 'mcq-user-19', notice: 7, type: 'mcq',
    q: 'A Resident individual ships his personal furniture abroad for his own use (personal consumption, not for sale). Is he subject to Notice 7\'s export-of-goods requirements?',
    opts: ['Yes — all Residents are covered without exception', 'No — export of goods by a Resident individual for personal consumption is carved out'],
    answer: 1,
    ref: 'Export of Goods — FAQ Q7',
    rationale: 'Notice 7 FAQ Q7: the requirements apply to all Residents including individuals, sole proprietorships and general partnerships — OTHER THAN export of goods by a Resident individual for personal consumption.',
  },
  {
    id: 'mcq-user-20', notice: 7, type: 'mcq',
    q: 'A Resident exporter expects the final payment 8 months after shipment for a reason NOT permitted under Notice 7. When must it apply to the FEP Authority for approval?',
    opts: ['No application is needed', 'Before the 6-month receipt period expires', 'Within 21 days after the end of the calendar year', 'Only if payment will exceed 24 months'],
    answer: 1,
    ref: 'Export of Goods — FAQ Q8',
    rationale: 'Notice 7 FAQ Q8: if payment is received after 6 months from shipment and the delay is not due to a permitted reason, FEP Authority approval is required and the application must be submitted BEFORE the 6-month period expires.',
  },
];
